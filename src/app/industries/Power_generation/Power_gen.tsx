...
const Power_Gen = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className="relative py-24 px-6 md:px-16 lg:px-32 bg-gradient-to-r from-yellow-50 via-gray-50 to-yellow-50"
    >
      {/* Header */}
      <div className="text-center mb-20">
        ...
        >
          Impact Plus partners with utilities, governments, and private
          operators to deliver safe, efficient, and sustainable power
          generation solutions — ensuring energy security while advancing
          the global energy transition.
        </p>
      </div>

      {/* Power Generation Cards */}
      ...
      <div className="mt-20 text-center max-w-4xl mx-auto">
        <p
          ...
          style={{ fontFamily: "Georgia, serif" }}
        >
          From feasibility to decommissioning, we provide
          comprehensive support across the entire power generation
          lifecycle. Our approach integrates innovation, compliance,
          and sustainability to power progress responsibly.
        </p>
        <p
          className="text-md text-gray-500 italic"
          style={{ fontFamily: "'Frangela', sans-serif" }}
        >
          “Driving reliable, safe, and sustainable energy for the
          future.”
        </p>
      </div>
    </section>
