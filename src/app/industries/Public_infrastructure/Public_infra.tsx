...
const PublicInfrastructure = () => {
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className="relative py-24 px-6 md:px-16 lg:px-32 bg-gradient-to-r from-gray-50 via-blue-50 to-gray-50"
    >
      {/* Header */}
      <div className="text-center mb-20">
        ...
        >
          Impact Plus empowers governments and development partners to design, deliver,
          and sustain infrastructure that enhances quality of life and drives long-term prosperity.
        </p>
      </div>
      ...
      <div className="mt-20 text-center max-w-4xl mx-auto">
        <p
          ...
          style={{ fontFamily: "Georgia, serif" }}
        >
          From planning to execution and lifecycle management, Impact Plus applies
          a systems-thinking approach to deliver resilient, sustainable, and
          high-impact infrastructure projects that meet both current and future needs.
        </p>
        <p
