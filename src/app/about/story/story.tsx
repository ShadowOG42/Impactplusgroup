...
//         </h1>
//         <p className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto font-[Montserrat]">
...
//             {/* Text */}
//             <div>
//               <h2 className="text-xl md:text-2xl font-semibold text-blue-900 mb-2 font-[Georgia]">
//                 {item.title}
//               </h2>
