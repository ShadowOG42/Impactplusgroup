...
export default function AdminPage() {
  ...
  if (loading)
    return (
      <p
        className={`text-center mt-10 ${montserrat.className}`}
  ...
  return (
    <section
      className={`min-h-screen bg-gray-50 flex flex-col items-center py-16 px-6 md:px-16 lg:px-32 ${montserrat.className}`}
    >
      {/* Logo */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-4xl">
        ...
        >
          ...
          <h2
            className="text-2xl font-semibold mb-2 text-center group-hover:text-blue-700"
            style={{ fontFamily: "Georgia, serif" }}
          >
            Messages
          </h2>
          <p className="text-gray-500 text-center" style={{ fontFamily: "Montserrat, sans-serif" }}>
